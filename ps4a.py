...
WORDLIST_FILENAME = "C:/Users/clkwa/PycharmProjects/EDX Python cs/words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        check = True
        for i in word:
            if handcopy.get(i) is not None and handcopy.get(i) > 0:
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    List = (sorted(list(hand.values()), reverse=True))[0]
    global currenthand, leng
    while List > 0:
        ...
        if Input == '.':
            ...
            if isValidWord(Input, hand, wordList) is False:
            ...
            # Otherwise (the word is valid):
                ...
                scorenew = getWordScore(Input, n)
                score += scorenew
                # Tell the user how many points the word earned, and the updated total score, in one line followed by a blank line
                print('" {} " earned {} points. Total: {} points'.format(Input, scorenew, score))
...
def playGame(wordList):
    ...
    while Input != 'e':
        ...
        if Input == 'n':
            ...
            try:
                playHand(currenthand, wordList, leng)
            except:
